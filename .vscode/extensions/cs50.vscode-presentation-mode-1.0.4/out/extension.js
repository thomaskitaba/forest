...
function getState(context, entry) {
    return context.workspaceState.get(entry);
}
function activatePresentationMode(context) {
...
function deactivatePresentationMode(context) {
...
function applyInactiveConfig(context) {
