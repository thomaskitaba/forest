...
## 0.7.2
- fixed issue [#97](https://github.com/janisdd/vscode-edit-csv/issues/97) - fixed rows/columns is ignored if `hasHeader` was changed

## 0.7.1
- fixed issue [#94](https://github.com/janisdd/vscode-edit-csv/issues/94) - find widget buttons are outside if panel
