    ...
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (didInitialize) {
                ...
                this.azureAccountService = new azureAccountService_1.AzureAccountService(this._connectionMgr.azureController, this.connectionManager.accountStore);
                this.azureResourceService = new azureResourceService_1.AzureResourceService(this._connectionMgr.azureController, azureResourceController, this.connectionManager.accountStore);
    ...
    showReleaseNotesPrompt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.doesExtensionLaunchedFileExist()) {
                ...
                const choice = yield this._vscodeWrapper.showInformationMessage('View mssql for Visual Studio Code release notes?', confirmText);
