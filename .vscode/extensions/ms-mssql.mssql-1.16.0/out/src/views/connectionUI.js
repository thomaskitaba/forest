...
class ConnectionUI {
    ...
    promptForCreateProfile() {
        return connectionProfile_1.ConnectionProfile.createProfile(this._prompter, this._connectionStore, this._context, this.connectionManager.azureController, this._accountStore);
    }
    ...
    promptForRetryCreateProfile(profile, isFirewallError = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result === LocalizedConstants.retryLabel) {
                return connectionProfile_1.ConnectionProfile.createProfile(this._prompter, this._connectionStore, this._context, this.connectionManager.azureController, this._accountStore, profile);
            }
            else {
