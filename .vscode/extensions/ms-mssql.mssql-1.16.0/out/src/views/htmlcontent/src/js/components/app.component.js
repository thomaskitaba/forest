...
let AppComponent = AppComponent_1 = class AppComponent {
    constructor(dataService, shortcuts, _el) {
    ...
    keyEvent(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isGridSelection = e.target.classList.contains('slick-cell');
            if (isGridSelection) {
            ...
            let result = yield this.shortcuts.getEvent(eString);
            if (result) {
