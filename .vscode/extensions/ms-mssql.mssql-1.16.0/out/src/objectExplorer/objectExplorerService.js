    ...
    handleSessionCreatedNotification() {
        ...
        const handler = (result) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.success) {
                ...
                if ((_a = self._currentNode.connectionInfo) === null || _a === void 0 ? void 0 : _a.password) {
                ...
                if (connectionCredentials.connectionString) {
                    ...
                    if (connectionCredentials_1.ConnectionCredentials.isPasswordBasedCredential(connectionCredentials)) {
                        ...
                        if (!connectionCredentials.azureAccountToken) {
                            let azureAccountToken = yield azureController.refreshToken(account, this._connectionManager.accountStore, providerSettings_1.default.resources.databaseResource, connectionCredentials.tenantId);
                            if (!azureAccountToken) {
                                ...
                                yield this._connectionManager.vscodeWrapper.showErrorMessage(errorMessage, LocalizedConstants.refreshTokenLabel).then((result) => __awaiter(this, void 0, void 0, function* () {
                                    if (result === LocalizedConstants.refreshTokenLabel) {
                                        yield azureController.populateAccountProperties(profile, this._connectionManager.accountStore, providerSettings_1.default.resources.databaseResource);
                                    }
                                    else {
                                        return undefined;
                                    }
