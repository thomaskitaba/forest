...
class ConnectionCredentials {
            ...
            let questions = [
                ...
                // AuthenticationType is required if there is more than 1 option on this platform
                {
                    ...
                    validate: (value) => {
                        ...
                        else if (value === utils.authTypeToString(interfaces_1.AuthenticationTypes.AzureMFA)) {
                            return undefined;
                        }
                        return undefined;
                    },
    ...
    static getAuthenticationTypesChoice() {
        let choices = [
            ...
            { name: LocalizedConstants.authTypeAzureActiveDirectory, value: utils.authTypeToString(interfaces_1.AuthenticationTypes.AzureMFA) }
        ];
        return choices;
    }
}
