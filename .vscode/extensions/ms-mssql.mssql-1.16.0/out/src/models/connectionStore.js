...
class ConnectionStore {
    constructor(_context, _credentialStore, _connectionConfig, _vscodeWrapper) {
        ...
        if (!this._credentialStore) {
            this._credentialStore = new credentialstore_1.CredentialStore(this._context);
        }
    ...
    saveProfile(profile, forceWritePlaintextPassword) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let savedProfile;
            if (profile.authenticationType === Utils.authTypeToString(interfaces_1.AuthenticationTypes.AzureMFA)) {
