...
class AzureAuth {
    ...
    async getAccountSecurityToken(account, tenantId, azureResource) {
        ...
        if (cachedTokens === null || cachedTokens === void 0 ? void 0 : cachedTokens.accessToken) {
            ...
            if (accessToken) {
                return Object.assign(Object.assign({}, accessToken), { expiresOn: expiresOn, tokenType: 'Bearer' });
            }
        }
        ...
        if (result === null || result === void 0 ? void 0 : result.accessToken) {
            return Object.assign(Object.assign({}, result.accessToken), { expiresOn: Number(result.expiresOn), tokenType: 'Bearer' });
        }
        return undefined;
    }
    /**
